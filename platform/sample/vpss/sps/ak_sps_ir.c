...
* File Name: ak_sps_ir.c
* Description: This is a simple example to show how the soft photosensitive (old method) module working.
* Notes:
* History: V1.0.0
*/
#include <unistd.h>
...
static const char *sps_version = "libapp_sps V1.0.00";
