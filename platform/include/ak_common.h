...
#define MODULE_NAME_AMP_MSG            "AMP_MSG"
...
#define MODULE_NAME_AUDIO_EFFECT       "AUDIO_EFFECT"
#define MODULE_NAME_AUDIO_DETECT       "AUDIO_DETECT"
#define MODULE_NAME_DUMP_FILE          "DUMP_FILE"
#define MODULE_NAME_NNE                "NNE"
...
#define MODULE_NAME_ATC_FILTER		   "FILTER"
...
enum module_id {
    ...
    MODULE_ID_NNE,
    MODULE_ID_SVP2,
    MODULE_ID_AUDIO_EFFECT,
    MODULE_ID_AUDIO_DETECT,
    MODULE_ID_DUMP_FILE,
    MODULE_ID_ATC_FILTER,
    MODULE_ID_AMP_MSG,
...
/*
 * ak_get_chip_type - get chip type
 * @void: void
 * return: chip type str
 */
const char *ak_get_chip_type(void);
