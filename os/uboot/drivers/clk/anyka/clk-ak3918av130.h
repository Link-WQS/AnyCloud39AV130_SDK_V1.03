...
/**
 * @brief ak3918av130 clock driver's resource headfile
 *
 */

#ifndef __CLK_AK3918AV130_H__
#define __CLK_AK3918AV130_H__

#include <asm/arch-ak3918av130/ak_cpu.h>
#include <dt-bindings/clock/ak3918av130-clock.h>
...
#else
#define MAC_OPCLK_SOURCE_READY_MASK       (0x01)
#define MAC_OPCLK_SOURCE_READY_SHIFT      (31)
#define MAC_OPCLK_READ_SHIFT              (30)
#define MAC_OPCLK_READ_MASK               (0x01)
