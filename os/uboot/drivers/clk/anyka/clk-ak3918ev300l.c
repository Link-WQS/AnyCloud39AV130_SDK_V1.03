...
U_BOOT_DRIVER(ak3918ev300l_factor_clk) = {
    .name = "ak3918ev300l_factor_clk",
    .id = UCLASS_CLK,
...
U_BOOT_DRIVER(ak3918ev300l_gate_clk) = {
    .name = "ak3918ev300l_gate_clk",
    .id = UCLASS_CLK,
...
U_BOOT_DRIVER(ak3918ev300l_fixed_clk) = {
    .name = "ak3918ev300l_fixed_clk",
    .id = UCLASS_CLK,
