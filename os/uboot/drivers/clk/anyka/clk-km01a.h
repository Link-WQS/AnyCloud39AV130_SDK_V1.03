...
/**
 * @brief km01a clock driver's resource headfile
 *
 */

#ifndef __CLK_KM01A_H__
#define __CLK_KM01A_H__

#include <asm/arch-km01a/ak_cpu.h>
#include <dt-bindings/clock/km01a-clock.h>
...
#ifndef CONFIG_MACH_AK3918AV100PLUS
#define MAC_OPCLK_DIV_VLD_CFG_MASK  (0x1)
#define MAC_OPCLK_DIV_VLD_CFG_SHIFT (9)
#else
#define MAC_OPCLK_DIV_VLD_CFG_MASK    (0x01)
#define MAC_OPCLK_DIV_VLD_CFG_SHIFT   (30)
#define MAC_OPCLK_SOURCE_EN_CFG_MASK  (0x01)
#define MAC_OPCLK_SOURCE_EN_CFG_SHIFT (9)
#define MAC_OPCLK_PLL_SEL_MASK        (0x3)
#define MAC_OPCLK_PLL_SEL_SHIFT       (6)
#define MAC_OPCLK_SOURCE_READY_MASK   (0x1)
#define MAC_OPCLK_SOURCE_READY_SHIFT  (31)
#endif
...
#if defined(CONFIG_KM01A_CODE)
#define EFUSE_TEMP_TRIM_CFG_MASK    (0x3F)
#define EFUSE_TEMP_TRIM_CFG_SHIFT   (3)
#endif
 ...
 */
#if defined(CONFIG_KM01A_CODE)
#define PLL3_ENSAT_CFG_MASK  (0x1)
#define PLL3_ENSAT_CFG_SHIFT (25)
#define PLL2_ENSAT_CFG_MASK  (0x1)
#define PLL2_ENSAT_CFG_SHIFT (24)
#endif
 ...
 */
#if defined(CONFIG_KM01A_CODE)
#define PP_VCLK_RST_CFG_MASK          (0x1)
#define PP_VCLK_RST_CFG_SHIFT         (31)
#define PP_SRC_CLK_EN_CFG_MASK        (0x1)
#define PP_SRC_CLK_EN_CFG_SHIFT       (30)
#define PP_SRC_CLK_SEL_CFG_MASK       (0x7)
#define PP_SRC_CLK_SEL_CFG_SHIFT      (27)
#define PP_SRC_CLK_DIV_CFG_MASK       (0x7)
#define PP_SRC_CLK_DIV_CFG_SHIFT      (24)
#endif
...
#if defined(CONFIG_KM01A_CODE)
#define GCLK_PDM_RST_CFG_SHIFT         (23)
#endif
