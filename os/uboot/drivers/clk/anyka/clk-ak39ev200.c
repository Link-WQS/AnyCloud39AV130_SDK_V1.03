...
U_BOOT_DRIVER(ak39ev200_factor_clk) = {
    .name = "ak39ev200_factor_clk",
    .id = UCLASS_CLK,
...
U_BOOT_DRIVER(ak39ev200_gate_clk) = {
    .name = "ak39ev200_gate_clk",
    .id = UCLASS_CLK,
...
U_BOOT_DRIVER(ak39ev200_fixed_clk) = {
    .name = "ak39ev200_fixed_clk",
    .id = UCLASS_CLK,
