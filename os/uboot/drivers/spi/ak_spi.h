...
// HIGH SPEED SPI CLK & GATE REGISTER
#define HS_SPI_CLK_CFG_REG          (CHIP_CONF_BASE_ADDR + 0x00000100)
...
#define AKSPI_1DATAWIRE     (0x0<<16)
#define AKSPI_2DATAWIRE     (0x1<<16)
#define AKSPI_4DATAWIRE     (0x2<<16)
