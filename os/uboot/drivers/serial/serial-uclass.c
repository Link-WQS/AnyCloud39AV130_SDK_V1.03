...
static void serial_find_console_or_panic(void)
{
	...
	//if (!SPL_BUILD || !CONFIG_IS_ENABLED(OF_CONTROL) || !blob)//add SPL and NO SPL need inter
	if (1) {
		/*
...
#define REG32(_register_)                               (*(volatile unsigned long *)(_register_))
 ulong tmp = 0;
 tmp = REG32(0X20170008);
 tmp |= 1 << 14;
 REG32(0X20170008) = tmp;
 
 
 tmp = REG32(0X2017001c);
 tmp |= 0 << 14;
 REG32(0X2017001c) = tmp;
 return 0;
}
