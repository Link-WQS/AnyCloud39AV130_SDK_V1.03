...
static int jl1101_config(struct phy_device *phydev)
{
	int ctl = 0;
...
static int jl1101_parse_status(struct phy_device *phydev)
{
	int mii_reg;
	int speed;
...
static int jl1101_startup(struct phy_device *phydev)
{
	int ret;
	...
	return jl1101_parse_status(phydev);
}
...
static struct phy_driver jl1101_driver = {
	...
	.config 	= &jl1101_config,
	.startup 	= &jl1101_startup,
	.shutdown 	= &genphy_shutdown,
};

int phy_sr_jl1101_init(void)
{
