...
static int ksz8041_config(struct phy_device *phydev)
{
	int ctl = 0;
...
static int ksz8041_parse_status(struct phy_device *phydev)
{
	int mii_reg;
	int speed;
...
static int ksz8041_startup(struct phy_device *phydev)
{
	int ret;
	...
	return ksz8041_parse_status(phydev);
}
...
static struct phy_driver ksz8041_driver = {
	...
	.config 	= &ksz8041_config,
	.startup 	= &ksz8041_startup,
	.shutdown 	= &genphy_shutdown,
};

int phy_sr_ksz8041_init(void)
{
