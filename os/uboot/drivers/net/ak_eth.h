...
#define TRANSMIT_DESC_SIZE                                                     \
    512 // 64 //256 //1500 //1400 // 256 // 32 Tx Descriptors needed in the
        // Descriptor pool/queue
#define RECEIVE_DESC_SIZE                                                      \
    512 // 64 //256 // 1500 // 1400 // 256   // 32 Rx Descriptors needed in the
        // Descriptor pool/queue
...
typedef struct DmaDescStruct {
    ...
    u32 buffer2; /* Network Buffer 2 pointer or next descriptor pointer
...
typedef struct synopGMACDeviceStruct {
    ...
    DmaDesc* RxDesc; /* start address of RX descriptors ring or chain, this is
                        used by the driver  */
    DmaDesc* rx_ring[RECEIVE_DESC_SIZE];
    DmaDesc* tx_ring[TRANSMIT_DESC_SIZE];
    ...
    u32 RxBusy; /* index of the rx descriptor owned by DMA, obtained by
                   gmac_get_rx_qptr()                   */
    u32 RxNext; /* index of the rx descriptor next available with driver, given
...
//#define GmacGmiiAddr        0x0000    /* GMII address Register(ext. Phy) */
//#define GmacGmiiData        0x0004    /* GMII data Register(ext. Phy) */
...
enum GmacGmiiAddrReg {
    ...
    GmiiCsrClkMask = 0x0000003C, /* CSR Clock bit Mask             4:2    , must
                                    :0x0000001C           */
    ...
    GmiiBusy = 0x00000001, /* (GB)GMII interface is busy                 0 RW
                              0      */
};
...
enum DmaBusModeReg {
    ...
    DmaArbitRr
    = 0x00000000, /* (DA) DMA RR arbitration                            1     RW
                     0     */
...
enum MMC_ENABLE {
    ...
    GmacMmcIntrRx
    = 0x0104, /* maintains interrupts generated by rx counters */
    GmacMmcIntrTx
    = 0x0108, /* maintains interrupts generated by tx counters */
    GmacMmcIntrMaskRx
...
enum DmaControlReg {
    ...
    DmaTxStart
    = 0x00002000, /* (ST)Start/Stop transmission                      13      RW
                     0       */
    ...
    DmaEnHwFlowCtrl
    = 0x00000100, /* (EFC)Enable HW flow control                      8       RW
                   */
...
enum GmacFrameFilterReg {
    ...
    GmacPromiscuousModeOn
    = 0x00000001, /* Receive all frames                      0         RW */
    GmacPromiscuousModeOff
    = 0x00000000, /* Receive filtered packets only 0       */
};
...
typedef enum { AK_PULLDOWN_ENABLE = 0, AK_PULLDOWN_DISABLE } T_GPIO_PD_CONFG;
