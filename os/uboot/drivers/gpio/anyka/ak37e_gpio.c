...
*
**/
static int ak37e_gpio_direction_input(struct udevice *dev, unsigned offset)
{
...
*
**/
static int ak37e_gpio_direction_output(struct udevice *dev, unsigned offset,
                       int value)
{
    void __iomem *reg_dir = AK_GPIO_DIR_BASE(offset);
...
*
**/
static int ak37e_gpio_get_value(struct udevice *dev, unsigned offset)
{
...
*
**/
static int ak37e_gpio_set_value(struct udevice *dev, unsigned offset,
                   int value)
{
    void __iomem *reg_out = AK_GPIO_OUT_BASE(offset);
    unsigned int bit = AK_GPIO_REG_SHIFT(offset);
...
static const struct dm_gpio_ops gpio_ak37e_ops = {
    .direction_input    = ak37e_gpio_direction_input,
    .direction_output   = ak37e_gpio_direction_output,
    .get_value      = ak37e_gpio_get_value,
    .set_value      = ak37e_gpio_set_value,
};

static int ak37e_gpio_probe(struct udevice *dev)
{
    ...
    uc_priv->gpio_count = AK37E_NUM_GPIOS;

    return 0;
}

static const struct udevice_id ak37e_gpio_ids[] = {
    { .compatible = "anyka,ak37e-gpio" },
    { }
};

U_BOOT_DRIVER(gpio_ak37e) = {
    .name   = "gpio_ak37e",
    .id = UCLASS_GPIO,
    .of_match = ak37e_gpio_ids,
    .ops    = &gpio_ak37e_ops,
    .probe  = ak37e_gpio_probe,
};
