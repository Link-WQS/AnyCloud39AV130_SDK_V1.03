...
#define AK3918EV300L_NUM_GPIOS         105
#define AK3918EV300L_NUM_BANKS         1
...
*
**/
static int ak3918ev300l_gpio_direction_input(struct udevice *dev,
                    unsigned offset)
{
...
*
**/
static int ak3918ev300l_gpio_direction_output(struct udevice *dev,
                    unsigned offset,
                       int value)
{
    void __iomem *reg_dir = AK_GPIO_DIR_BASE(offset);
...
*
**/
static int ak3918ev300l_gpio_get_value(struct udevice *dev, unsigned offset)
{
...
*
**/
static int ak3918ev300l_gpio_set_value(struct udevice *dev, unsigned offset,
                   int value)
{
    void __iomem *reg_out = AK_GPIO_OUT_BASE(offset);
    unsigned int bit = AK_GPIO_REG_SHIFT(offset);
...
static const struct dm_gpio_ops gpio_ak3918ev300l_ops = {
    .direction_input    = ak3918ev300l_gpio_direction_input,
    .direction_output   = ak3918ev300l_gpio_direction_output,
    .get_value      = ak3918ev300l_gpio_get_value,
    .set_value      = ak3918ev300l_gpio_set_value,
};

static int ak3918ev300l_gpio_probe(struct udevice *dev)
{
    ...
    uc_priv->gpio_count = AK3918EV300L_NUM_GPIOS;

    return 0;
}

static const struct udevice_id ak3918ev300l_gpio_ids[] = {
    { .compatible = "anyka,ak3918ev300l-gpio" },
    { }
};

U_BOOT_DRIVER(gpio_ak3918ev300l) = {
    .name   = "gpio_ak3918ev300l",
    .id = UCLASS_GPIO,
    .of_match =  ak3918ev300l_gpio_ids,
    .ops    = &gpio_ak3918ev300l_ops,
    .probe  =  ak3918ev300l_gpio_probe,
};
