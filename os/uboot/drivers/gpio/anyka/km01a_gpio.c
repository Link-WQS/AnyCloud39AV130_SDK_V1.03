...
#define AK3918AV100_NUM_GPIOS         105
#define AK3918AV100_NUM_BANKS         1
...
*
**/
static int ak3918av100_gpio_direction_input(struct udevice *dev,
                        unsigned offset)
{
...
*
**/
static int ak3918av100_gpio_direction_output(struct udevice *dev,
                       unsigned offset,
                       int value)
{
    void __iomem *reg_dir = AK_GPIO_DIR_BASE(offset);
...
*
**/
static int ak3918av100_gpio_get_value(struct udevice *dev, unsigned offset)
{
...
*
**/
static int ak3918av100_gpio_set_value(struct udevice *dev, unsigned offset,
                   int value)
{
    void __iomem *reg_out = AK_GPIO_OUT_BASE(offset);
    unsigned int bit = AK_GPIO_REG_SHIFT(offset);
...
static const struct dm_gpio_ops gpio_ak3918av100_ops = {
    .direction_input    = ak3918av100_gpio_direction_input,
    .direction_output   = ak3918av100_gpio_direction_output,
    .get_value      = ak3918av100_gpio_get_value,
    .set_value      = ak3918av100_gpio_set_value,
};

static int ak3918av100_gpio_probe(struct udevice *dev)
{
    ...
    uc_priv->gpio_count = AK3918AV100_NUM_GPIOS;

    return 0;
}

static const struct udevice_id ak3918av100_gpio_ids[] = {
    { .compatible = "anyka,ak3918av100-gpio" },
    { }
};

U_BOOT_DRIVER(gpio_ak3918av100) = {
    .name   = "gpio_ak3918av100",
    .id = UCLASS_GPIO,
    .of_match = ak3918av100_gpio_ids,
    .ops    = &gpio_ak3918av100_ops,
    .probe  = ak3918av100_gpio_probe,
};
