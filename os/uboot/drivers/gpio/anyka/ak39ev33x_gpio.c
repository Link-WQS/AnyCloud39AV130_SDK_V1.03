...
#define AK33X_NUM_GPIOS         86
#define AK33X_NUM_BANKS         1
...
#define AK_GPIO_EDGE_STATUS1    0x3c
...
*
**/
static int ak39ev330_gpio_direction_input(struct udevice *dev, unsigned offset)
{
...
*
**/
static int ak39ev330_gpio_direction_output(struct udevice *dev, unsigned offset,
                       int value)
{
    void __iomem *reg_dir = AK_GPIO_DIR_BASE(offset);
...
*
**/
static int ak39ev330_gpio_get_value(struct udevice *dev, unsigned offset)
{
...
*
**/
static int ak39ev330_gpio_set_value(struct udevice *dev, unsigned offset,
                   int value)
{
    void __iomem *reg_out = AK_GPIO_OUT_BASE(offset);
    unsigned int bit = AK_GPIO_REG_SHIFT(offset);
...
static const struct dm_gpio_ops gpio_ak39ev330_ops = {
    .direction_input    = ak39ev330_gpio_direction_input,
    .direction_output   = ak39ev330_gpio_direction_output,
    .get_value      = ak39ev330_gpio_get_value,
    .set_value      = ak39ev330_gpio_set_value,
};

static int ak39ev330_gpio_probe(struct udevice *dev)
{
    ...
    uc_priv->gpio_count = AK33X_NUM_GPIOS;

    return 0;
}

static const struct udevice_id ak39ev330_gpio_ids[] = {
    { .compatible = "anyka,ak39ev330-gpio" },
    { }
};

U_BOOT_DRIVER(gpio_ak39ev330) = {
    .name   = "gpio_ak39ev330",
    .id = UCLASS_GPIO,
    .of_match = ak39ev330_gpio_ids,
    .ops    = &gpio_ak39ev330_ops,
    .probe  = ak39ev330_gpio_probe,
};
