...
#include <linux/io.h>
#include <linux/err.h>
#include <dt-bindings/pinctrl/ak_3918av130_pinctrl.h>
...
static struct gpio_sharepin ak_sharepin[] = {
    ...
    /* GPIO51, UART0_TXD */
    {51, 5, 3, 6, 19, 19, 19, 19, 19, 2, CFG_ALL_EN},
    /* GPIO52, UART0_RXD */
    {52, 5, 6, 8, 20, 20, 20, 20, 20, 2, CFG_ALL_EN},
    /* GPIO42, eMMC_D3, SPI0_WP(IO1) */
    {42, 4, 6, 20, 10, 10, 10, 10, 10, 3, CFG_ALL_EN},
    /* GPIO43, eMMC_D0, SPI0_DIN(IO1) */
    {43, 4, 9, 22, 11, 11, 11, 11, 11, 3, CFG_ALL_EN},
    /* GPIO44, eMMC_D1, SFC_CS */
    {44, 4, 12, 24, 12, 12, 12, 12, 12, 3, CFG_ALL_EN},
    /* GPIO45, eMMC_D2, SPI0_HOLD(IO3) */
    {45, 4, 15, 26, 13, 13, 13, 13, 13, 3, CFG_ALL_EN},
    /* GPIO46, eMMC_MCLK, SPI0_CLK */
    {46, 4, 18, 28, 14, 14, 14, 14, 14, 3, CFG_ALL_EN},
    /* GPIO47, eMMC_CMD, SPI0_DOUT(IO0 */
    {47, 4, 21, 30, 15, 15, 15, 15, 15, 3, CFG_ALL_EN},
#else
    /* PIN 
    funcmux_reg_no
    funcmux_reg_offset
    ...
    {3, 0, 9, 6, 3, 3, 3, 3, 3, 4, CFG_ALL_EN},
    ...
    {48, 4, 24, 0, 16, 16, 16, 16, 16, 4, CFG_ALL_EN},
    /* GPIO49, PWM1, UART1_RXD, TWI1_SDA */
    {49, 4, 27, 2, 17, 17, 17, 17, 17, 4, CFG_ALL_EN},
    /* GPIO50, SWITCH1_SEL, PWM_CSI1 */
    {50, 5, 0, 4, 18, 18, 18, 18, 18, 5, CFG_ALL_EN},
    /* GPIO51, UART0_TXD */
    {51, 5, 3, 6, 19, 19, 19, 19, 19, 2, CFG_ALL_EN},
    /* GPIO52, UART0_RXD */
    {52, 5, 6, 8, 20, 20, 20, 20, 20, 2, CFG_ALL_EN},
    /* GPIO53, PWM_CSI0, CSI2_SCLK */
    {53, 5, 9, 10, 21, 21, 21, 21, 21, 3, CFG_ALL_EN},
    /* GPIO54, PWM_CSI1, CSI3_SCLK */
    {54, 5, 12, 12, 22, 22, 22, 22, 22, 3, CFG_ALL_EN},
    /* GPIO55, SPI2_CS0, UART2_RXD, PWM3, SWITCH0_SEL */
    {55, 5, 15, 14, 23, 23, 23, 23, 23, 5, CFG_ALL_EN},
    /* GPIO56, SPI2_CLK, UART2_TXD, PWM4, SWITCH1_SEL */
    {56, 5, 18, 16, 24, 24, 24, 24, 24, 5, CFG_ALL_EN},
    /* GPIO57, SPI2_DIN(IO1), UART2_MX0, TWI1_SCL */
    {57, 5, 21, 18, 25, 25, 25, 25, 25, 4, CFG_ALL_EN},
    /* GPIO58, SPI2_CS1, UART2_MX1, TWI1_SDA, SD1_CMD, SPI2_DATA3 */
    {58, 5, 24, 20, 26, 26, 26, 26, 26, 6, CFG_ALL_EN},
    /* GPIO59, SPI2_DOUT(IO0), PWM1, PWM_CSI2, SPI2_CLK */
    {59, 5, 27, 22, 27, 27, 27, 27, 27, 6, CFG_ALL_EN},

    /* GPIO65, SPI2_CS0, JTAG0_RSTN, UART2_RXD, SD1_MCLK, JTAG1_RSTN */
    {65, 6, 15, 2, 1, 1, 1, 1, 1, 6, CFG_ALL_EN},
    /* GPIO66, SPI2_CLK, JTAG0_TCK, UART2_TXD, SD1_D2, JTAG1_TCK */
    {66, 6, 18, 4, 2, 2, 2, 2, 2, 6, CFG_ALL_EN},
    /* GPIO67, SPI2_DIN(IO1), JTAG0_TMS, PWM2, UART2_MX0, JTAG1_TMS, SD1_D3 */
    {67, 6, 21, 6, 3, 3, 3, 3, 3, 7, CFG_ALL_EN},
    /* GPIO68, SPI2_CS1, JTAG0_TDI, PWM3, JTAG1_TDI, SD1_D0, SPI2_D2 */
    {68, 6, 24, 8, 4, 4, 4, 4, 4, 7, CFG_ALL_EN},
    /* GPIO69, SPI2_DOUT(IO0), JTAG0_TDO, UART2_MX1, SD1_D1, JTAG1_TDO */
    {69, 6, 27, 10, 5, 5, 5, 5, 5, 6, CFG_ALL_EN},
    /* GPIO70, AIN1 */
    {70, 7, 0, 12, 6, 6, 6, 6, 6, 2, CFG_ALL_EN},
    /* GPIO71, AIN0 */
    {71, 7, 3, 14, 7, 7, 7, 7, 7, 2, CFG_ALL_EN},
    /* GPIO72, MIPI_RX_L4P */
    {72, 7, 6, 16, 8, 8, 8, 8, 8, 2, CFG_ALL_EN},
    /* GPIO73, MIPI_RX_L4N */
    {73, 7, 9, 18, 9, 9, 9, 9, 9, 2, CFG_ALL_EN},
    /* GPIO74, MIPI_RX_L5P */
    {74, 7, 12, 20, 10, 10, 10, 10, 10, 2, CFG_ALL_EN},
    /* GPIO75, MIPI_RX_L5N */
    {75, 7, 15, 22, 11, 11, 11, 11, 11, 2, CFG_ALL_EN},
    /* GPIO78, MIPI_RX_L1P */
    {78, 7, 24, 28, 14, 14, 14, 14, 14, 3, CFG_ALL_EN},
    /* GPIO79, MIPI_RX_L1N */
    {79, 7, 27, 30, 15, 15, 15, 15, 15, 3, CFG_ALL_EN},

    /* PWR_SEQ, GPIO80 */
    //{80, x, x, x, 16, 16, 16, 16, 16, 16, CFG_ALL_EN},
    /* PWR_WAKEUP, GPIO81 */
    //{81, x, x, x, 17, 17, 17, 17, 17, 17, CFG_ALL_EN},

    /* GPIO98, SWITCH0_SEL, PWM_CSI1, UART1_MX0 */
    {98, 9, 24, 4, 2, 2, 2, 2, 2, 4, CFG_ALL_EN},
    /* GPIO99, MIPI_RX_L0P, CSI_D7 */
    {99, 9, 27, 6, 3, 3, 3, 3, 3, 3, CFG_ALL_EN},
    /* GPIO100, MIPI_RX_L0N, CSI_PCLK */
    {100, 10, 0, 8, 4, 4, 4, 4, 4, 3, CFG_ALL_EN},
    /* GPIO101, MIPI_RX_L2P, CSI_D9 */
    {101, 10, 3, 10, 5, 5, 5, 5, 5, 3, CFG_ALL_EN},
    /* GPIO102, MIPI_RX_L2N, CSI_D8 */
    {102, 10, 6, 12, 6, 6, 6, 6, 6, 3, CFG_ALL_EN},
    /* GPIO103, MIPI_RX_L3P */
    {103, 10, 9, 14, 7, 7, 7, 7, 7, 2, CFG_ALL_EN},
    /* GPIO104, MIPI_RX_L3N */
    {104, 10, 12, 16, 8, 8, 8, 8, 8, 2, CFG_ALL_EN},
#endif
};
...
static int ak3918av130_pmx_set(int pin, int sel)
{
...
static int ak3918av130_pinconf_set(int pin, unsigned int configs)
{
...
static int ak3918av130_pinctrl_set_state(struct udevice *dev,
                    struct udevice *config)
{
    ...
    for (i = 0; i < count_pins; i++) {
        ...
        ak3918av130_pmx_set(pin, sel);
        ak3918av130_pinconf_set(pin, conf);
    }

    return 0;
}

const struct pinctrl_ops ak3918av130_pinctrl_ops  = {
    .set_state = ak3918av130_pinctrl_set_state,
};
...
static void disable_gpio_retention(void)
{
    ...
    regval = __raw_readl(0x08000000 + 0x260);
    regval &= ~(1UL << 0);
    __raw_writel(regval, 0x08000000 + 0x260);
#else
...
static int ak3918av130_pinctrl_probe(struct udevice *dev)
{
    struct clk clk;
    int ret;
...
static const struct udevice_id ak3918av130_pinctrl_match[] = {
    { .compatible = "anyka,ak3918av130-pinctrl"},
    {}
};

U_BOOT_DRIVER(ak3918av130_pinctrl) = {
    .name = "pinctrl_ak3918av130",
    .id = UCLASS_PINCTRL,
    .of_match = ak3918av130_pinctrl_match,
    .probe = ak3918av130_pinctrl_probe,
    .ops = &ak3918av130_pinctrl_ops,
};
