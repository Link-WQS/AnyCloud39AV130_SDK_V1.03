...
#include <linux/io.h>
#include <linux/err.h>
#include <dt-bindings/pinctrl/ak_3918av100_pinctrl.h>
...
static struct gpio_sharepin ak_sharepin[] = {
...
#else
    /* PIN funcmux_reg_no funcmux_reg_offset 
    pad_drv_offset pad_ie_offset pupd_en_offset 
    ...
    /* GPIO12, SD1_D3, PWM4 */
    {12, 1, 6, 24, 12, 12, 12, 12, 12, 3, CFG_ALL_EN},
    /* Not support */
    {13, 0, 0, 26, 13, 13, 13, 13, 13, AK_GPIO_CONF_INVALID, CFG_ALL_DISABLE},
    /* Not support */
    {14, 0, 0, 28, 14, 14, 14, 14, 14, AK_GPIO_CONF_INVALID, CFG_ALL_DISABLE},
    /* Not support */
    {15, 0, 0, 30, 15, 15, 15, 15, 15, AK_GPIO_CONF_INVALID, CFG_ALL_DISABLE},
    ...
    {28, 3, 0,  0,  24, 28, 28, 28, 28, 3, CFG_ALL_EN},
    {29, 3, 3,  0,  26, 29, 29, 29, 29, 2, CFG_ALL_EN},

    /* GPIO30, CS1_SCLK, PWM0 */
    {30, 2, 15, 28, 30, 30, 30, 30, 30, 3, CFG_ALL_EN},
    /* GPIO31, SD0_D2, JTAG_TDI, eMMC_D3, SD1_D1 */
    {31, 3, 6, 30, 31, 31, 31, 31, 31, 5, CFG_ALL_EN},
    /* GPIO32, SD0_D3, JTAG_RSTN, eMMC_D0, SD1_D0 */
    {32, 3, 9, 0, 0, 0, 0, 0, 0, 5, CFG_ALL_EN},
    /* GPIO33, SD0_CMD, eMMC_CMD, SD1_CMD */
    {33, 3, 12, 2, 1, 1, 1, 1, 1, 4, CFG_ALL_EN},
    /* GPIO34, SD0_MCLK, JTAG_TCLK, eMMC_MCLK, SD1_MCLK */
    {34, 3, 15, 4, 2, 2, 2, 2, 2, 5, CFG_ALL_EN},
    /* GPIO35, SD0_D0, JTAG_TMS, eMMC_D1, SD1_D3 */
    {35, 3, 18, 6, 3, 3, 3, 3, 3, 5, CFG_ALL_EN},
    /* GPIO36, SD0_D1, JTAG_TDO, eMMC_D2, SD1_D2 */
    {36, 3, 21, 8, 4, 4, 4, 4, 4, 5, CFG_ALL_EN},
    /* GPIO only */
    {37, 0, 0, 10, 5, 5, 5, 5, 5, 1, CFG_ALL_EN},
    /* GPIO38, eMMC_D7, SPI1_CS, SD1_D3 */
    {38, 3, 27, 12, 6, 6, 6, 6, 6, 4, CFG_ALL_EN},
    /* GPIO39, eMMC_D6, SPI1_CLK, SD1_D2 */
    {39, 4, 0, 14, 7, 7, 7, 7, 7, 4, CFG_ALL_EN},
    /* GPIO40, eMMC_D5, SPI1_DOUT(IO0), TWI1_SCL */
    {40, 4, 3, 16, 8, 8, 8, 8, 8, 4, CFG_ALL_EN},
    /* GPIO41, eMMC_D4, SPI1_DIN(IO1), TWI1_SDA  */
    {41, 4, 6, 18, 9, 9, 9, 9, 9, 4, CFG_ALL_EN},
    /* GPIO42, eMMC_D3, SPI0_WP(IO1) */
    {42, 4, 9, 20, 10, 10, 10, 10, 10, 3, CFG_ALL_EN},
    /* GPIO43, eMMC_D0, SPI0_DIN(IO1) */
    {43, 4, 12, 22, 11, 11, 11, 11, 11, 3, CFG_ALL_EN},
    ...
    {52, 5, 9, 8, 20, 20, 20, 20, 20, 2, CFG_ALL_EN},
    /* GPIO53, PWM_CSI0 */
    {53, 5, 12, 10, 21, 21, 21, 21, 21, 2, CFG_ALL_EN},
    /* GPIO54, PWM_CSI1 */
    {54, 5, 15, 12, 22, 22, 22, 22, 22, 2, CFG_ALL_EN},
    ...
    /* GPIO57, SPI2_DIN(IO1), UART2_CTS, TWI1_SCL */
    {57, 5, 24, 18, 25, 25, 25, 25, 25, 4, CFG_ALL_EN},
    /* GPIO58, SPI2_CS1, UART2_RTS, TWI1_SDA */
    {58, 5, 27, 20, 26, 26, 26, 26, 26, 5, CFG_ALL_EN},
    /* GPIO59, SPI2_DOUT(IO0), PWM1 */
    {59, 6, 0, 22, 27, 27, 27, 27, 27, 3, CFG_ALL_EN},
    /* GPIO60, TWI1_SCL, I2S_MCLK */
    {60, 6, 3, 24, 28, 28, 28, 28, 28, 3, CFG_ALL_EN},
    /* GPIO61, TWI1_SDA, I2S_MBCLK */
    {61, 6, 6, 26, 29, 29, 29, 29, 29, 3, CFG_ALL_EN},
    /* GPIO62, UART1_TXD, I2S_LRCLK*/
    {62, 6, 9, 28, 30, 30, 30, 30, 30, 3, CFG_ALL_EN},
    /* GPIO63, UART1_RXD, I2S_DOUT */
    {63, 6, 12, 30, 31, 31, 31, 31, 31, 3, CFG_ALL_EN},
    /* GPIO64, PWM2, I2S_DIN*/
    {64, 6, 15, 0, 0, 0, 0, 0, 0, 3, CFG_ALL_EN},
    /* JTAG_RSTN, SPI2_CS0, GPIO65, UART2_RXD, I2S_MCLK, SD1_MCLK */
    {65, 6, 18, 2, 1, 1, 1, 1, 1, 6, CFG_ALL_EN},
    /* JTAG_TCLK, SPI2_CLK, GPIO66, UART2_TXD, I2S_BCLK, SD1_D2 */
    {66, 6, 21, 4, 2, 2, 2, 2, 2, 5, CFG_ALL_EN},
    /* JTAG_TMS, GPIO67, PWM2, UART2_CTS, I2S_LRCLK, SD1_D3 */
    {67, 6, 24, 6, 3, 3, 3, 3, 3, 7, CFG_ALL_EN},
    /* JTAG_TDI, SPI2_CS1, GPIO68, PWM3, I2S_DOUT, SD1_D0 */
    {68, 6, 27, 8, 4, 4, 4, 4, 4, 7, CFG_ALL_EN},
    /* JTAG_TDO, SPI2_DOUT(IO0),GPIO69, UART2_RTS, I2S_DIN, SD1_D1*/
    {69, 7, 0, 10, 5, 5, 5, 5, 5, 6, CFG_ALL_EN},
    /* GPIO70, AIN1 */
    {70, 8, 24, 12, 6, 6, 6, 6, 6, 2, CFG_ALL_EN},
    /* GPIO71, AIN0 */
    {71, 8, 27, 14, 7, 7, 7, 7, 7, 2, CFG_ALL_EN},
    /* MIPI_RX_L4P, CSI1_D4, GPIO72 */
    {72, 9, 24, 16, 8, 8, 8, 8, 8, 3, CFG_ALL_EN},
    /* MIPI_RX_L4N, CSI1_D1, GPIO73*/
    {73, 9, 27, 18, 9, 9, 9, 9, 9, 3, CFG_ALL_EN},
    /* MIPI_RX_L5P, CSI1_D2, GPIO74*/
    {74, 10, 0, 20, 10, 10, 10, 10, 10, 3, CFG_ALL_EN},
    /* MIPI_RX_L5N, CSI1_D0, GPIO75*/
    {75, 10, 3, 22, 11, 11, 11, 11, 11, 3, CFG_ALL_EN},
    /* Not support */
    {76, 0, 0, 24, 12, 12, 12, 12, 12,AK_GPIO_CONF_INVALID, CFG_ALL_DISABLE},
    /* GPIO77, PWM3*/
    {77, 10, 6, 26, 13, 13, 13, 13, 13, 2, CFG_ALL_EN},
    /* MIPI_RX_L1P, CSI1_D6, GPIO78*/
    {78, 9, 6, 28, 14, 14, 14, 14, 14, 3, CFG_ALL_EN},
    /* MIPI_RX_L1N, CSI1_D5, GPIO79*/
    {79, 9, 9, 30, 15, 15, 15, 15, 15, 5, CFG_ALL_EN},
    /* PWM_SEQ, GPIO80 */
    {80, 0, 0, 6, 0, 0, 0, 0, 0, AK_GPIO_CONF_INVALID, CFG_ALL_DISABLE},
    /* PWM_WAKEUP, GPIO81 */
    {81, 0, 0, 0, 0, 0, 0, 0, 0, AK_GPIO_CONF_INVALID, CFG_ALL_DISABLE},

    /* for AK3918AV100P AK3918AV100X */
    {82, 7, 3, 1,   4, 18, 18, 18, 18, 2,  CFG_ALL_EN},
    {83, 7, 6, 1,   6, 19, 19, 19, 19, 2,  CFG_ALL_EN},
    {84, 7, 9, 1,   8, 20, 20, 20, 20, 2,  CFG_ALL_EN},
    {85, 7, 12, 1,  10, 21, 21, 21, 21, 2, CFG_ALL_EN},
    {86, 7, 15, 1,  12, 22, 22, 22, 22, 2, CFG_ALL_EN},
    {87, 7, 18, 1,  14, 23, 23, 23, 23, 2, CFG_ALL_EN},
    {88, 7, 21, 1,  16, 24, 24, 24, 24, 2, CFG_ALL_EN},
    {89, 7, 24, 1,  18, 25, 25, 25, 25, 2, CFG_ALL_EN},
    {90, 7, 27, 1,  20, 26, 26, 26, 26, 2, CFG_ALL_EN},
    {91, 8, 0,  1,  22, 27, 27, 27, 27, 2, CFG_ALL_EN},

    /* SYS_RSTN_OUT, GPIO98 */
    {98, 0, 0, 4, 2, 2, 2, 2, 2, 2, CFG_ALL_EN},
    /* MIPI_RX_L0P, CSI_D7, GPIO99 */
    {99, 0, 0, 6, 3, 3, 3, 3, 3, 3, CFG_ALL_EN},
    /* MIPI_RX_L0N, CSI_CLK, GPIO100 */
    {100, 0, 0, 8, 4, 4, 4, 4, 4, 3, CFG_ALL_EN},
    /* MIPI_RX_L2P, CSI_D9, GPIO101 */
    {101, 0, 0, 10, 5, 5, 5, 5, 5, 3, CFG_ALL_EN},
    /* MIPI_RX_L2N, CSI_D8, GPIO102 */
    {102, 0, 0, 12, 6, 6, 6, 6, 6, 3, CFG_ALL_EN},
    /* MIPI_RX_L3P, CSI_D10, GPIO103 */
    {103, 0, 0, 14, 7, 7, 7, 7, 7, 3, CFG_ALL_EN},
    /* MIPI_RX_L3N, CSI_D11, GPIO104 */
    {104, 0, 0, 16, 8, 8, 8, 8, 8, 3, CFG_ALL_EN},
#endif
};
...
static int ak3918av100_pmx_set(int pin, int sel)
{
...
static int ak3918av100_pinconf_set(int pin, unsigned int configs)
{
...
static int ak3918av100_pinctrl_set_state(struct udevice *dev,
                    struct udevice *config)
{
    ...
    for (i = 0; i < count_pins; i++) {
        ...
        ak3918av100_pmx_set(pin, sel);
        ak3918av100_pinconf_set(pin, conf);
    }

    return 0;
}

const struct pinctrl_ops ak3918av100_pinctrl_ops  = {
    .set_state = ak3918av100_pinctrl_set_state,
};
...
static int ak3918av100_pinctrl_probe(struct udevice *dev)
{
    struct clk clk;
    int ret;
...
static const struct udevice_id ak3918av100_pinctrl_match[] = {
    { .compatible = "anyka,ak3918av100-pinctrl"},
    {}
};

U_BOOT_DRIVER(ak3918av100_pinctrl) = {
    .name = "pinctrl_ak3918av100",
    .id = UCLASS_PINCTRL,
    .of_match = ak3918av100_pinctrl_match,
    .probe = ak3918av100_pinctrl_probe,
    .ops = &ak3918av100_pinctrl_ops,
};
