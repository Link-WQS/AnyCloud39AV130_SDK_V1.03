...
#define TIMER5_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x01C0)
#define TIMER5_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x01C4)
#define TIMER6_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x01C8)
#define TIMER6_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x01CC)
#define TIMER7_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x0200)
#define TIMER7_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x0204)
#define TIMER8_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x0208)
#define TIMER8_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x020c)
#define TIMER9_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x0210)
#define TIMER9_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x0214)
