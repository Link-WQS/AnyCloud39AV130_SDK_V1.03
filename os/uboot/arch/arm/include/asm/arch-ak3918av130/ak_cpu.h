 ...
 * ¼Ä´æÆ÷µÄÎ»¶¨ÒåÔ­ÔòÉÏ·ÅÔÚ¸÷¸öÇý¶¯Ä£¿éµÄÍ·ÎÄ¼þÖÐ¶¨
 * Òå£¬Èç¹û¶ÔÓ¦µÄÇý¶¯Ä£¿éÌ«Ð¡Ã»ÓÐÍ·ÎÄ¼þ£¬
 * Ôò¿É·ÅÔÚ´Ë´¦¶¨Òå
 */
...
#define SDADC_SPI0_SDDAC_CTRL_REG       (CHIP_CONF_BASE_ADDR + 0x0000000C)
#define SDADC_SDDAC_HIGH_SPEED_CTRL_REG (CHIP_CONF_BASE_ADDR + 0x00000010)
...
#define SHARE_PIN_CFG10_REG                                                    \
    (CHIP_CONF_BASE_ADDR + 0x000001A0) // SHARE PIN CFG10

#define PU_PD_ENABLE_CFG0_REG (CHIP_CONF_BASE_ADDR + 0x00000264)
#define PU_PD_ENABLE_CFG1_REG (CHIP_CONF_BASE_ADDR + 0x00000268)
#define PU_PD_ENABLE_CFG2_REG (CHIP_CONF_BASE_ADDR + 0x0000026C)
#define PU_PD_ENABLE_CFG3_REG (CHIP_CONF_BASE_ADDR + 0x00000270)

#define PU_PD_SEL_CFG0_REG (CHIP_CONF_BASE_ADDR + 0x00000274)
#define PU_PD_SEL_CFG1_REG (CHIP_CONF_BASE_ADDR + 0x00000278)
#define PU_PD_SEL_CFG2_REG (CHIP_CONF_BASE_ADDR + 0x0000027C)
#define PU_PD_SEL_CFG3_REG (CHIP_CONF_BASE_ADDR + 0x00000280)

#define PAD_DRV_CFG0_REG (CHIP_CONF_BASE_ADDR + 0x000001A4)
#define PAD_DRV_CFG1_REG (CHIP_CONF_BASE_ADDR + 0x000001A8)
#define PAD_DRV_CFG2_REG (CHIP_CONF_BASE_ADDR + 0x000001AC)
#define PAD_DRV_CFG3_REG (CHIP_CONF_BASE_ADDR + 0x000001B0)
#define PAD_DRV_CFG4_REG (CHIP_CONF_BASE_ADDR + 0x000001B4)
#define PAD_DRV_CFG5_REG (CHIP_CONF_BASE_ADDR + 0x000001B8)
#define PAD_DRV_CFG6_REG (CHIP_CONF_BASE_ADDR + 0x000001BC)

#define PAD_IE_CFG0_REG (CHIP_CONF_BASE_ADDR + 0x000001C0)
#define PAD_IE_CFG1_REG (CHIP_CONF_BASE_ADDR + 0x000001C4)
#define PAD_IE_CFG2_REG (CHIP_CONF_BASE_ADDR + 0x000001C8)
#define PAD_IE_CFG3_REG (CHIP_CONF_BASE_ADDR + 0x000001CC)

#define PAD_SL_CFG0_REG (CHIP_CONF_BASE_ADDR + 0x000001D0)
#define PAD_SL_CFG1_REG (CHIP_CONF_BASE_ADDR + 0x000001D4)
#define PAD_SL_CFG2_REG (CHIP_CONF_BASE_ADDR + 0x000001D8)
#define PAD_SL_CFG3_REG (CHIP_CONF_BASE_ADDR + 0x000001DC)

#define PAD_ST_CFG0_REG (CHIP_CONF_BASE_ADDR + 0x00000284)
#define PAD_ST_CFG1_REG (CHIP_CONF_BASE_ADDR + 0x00000288)
#define PAD_ST_CFG2_REG (CHIP_CONF_BASE_ADDR + 0x0000028C)
#define PAD_ST_CFG3_REG (CHIP_CONF_BASE_ADDR + 0x00000290)

#define TIMER_BASE_ADDR (MODULE_CONF_BASE_ADDR + 0x1110000)
#define GPIO_MODULE_BASE_ADDR (MODULE_CONF_BASE_ADDR + 0x170000)
 ...
 */
#define SPI_MODULE_BASE_ADDR 0x21100000 // SPI
...
#define ASPEN_SPI_WORK_MODE (0x24)
...
#define outl(v, p)  do { \
    ...
    if (((unsigned long)(p) & 0xFFFF0000) == 0x08000000 || \
       ((unsigned long)(p) & 0xFFFF0000) == 0x48000000) { \
        inl(0x00000000); \
    } \
} while (0)
#else
#define outl(v, p)  do { \
    ...
    if (((unsigned long)(p) & 0xFFFF0000) == 0x08000000 || \
       ((unsigned long)(p) & 0xFFFF0000) == 0x48000000) { \
        printf("**outl this is 0x0800 or 0x4800** now read 0x00000000\n"); \
        printf("**outl this is  led 1\n"); \
       (*(volatile unsigned long*)(0x20170008) = (0x40)); \
       (*(volatile unsigned long*)(0x2017001c) = (0x40)); \
        inl(0x00000000); \
        printf("**outl this is  led 0\n"); \
       (*(volatile unsigned long*)(0x2017001c) = (0x0)); \
    } \
} while (0)
