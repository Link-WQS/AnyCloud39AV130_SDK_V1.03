 ...
 *
 * @note:
 * 1. ¶ÔÓÚmmiÏµÍ³ÖÐÒÑ¶¨ÒåÁËµÄgpio£¬²»ÐèÒªÉ¾³ýÏà¹Ø´
 *      úÂë£¬Ö»Ðè½«Æä¶¨ÒåÎªINVALID_GPIO
 
 * 2. Èç¹ûÐèÒªÓÃµ½À©Õ¹io£¬Ö»ÐèÒª´ò¿ªGPIO_MULTIPLE_USEºê£¬²¢ÉèÖÃ¶ÔÓ¦µÄgpio
 *    GPIO_EXPAND_OUT1ºÍGPIO_EXPAND_OUT2£¬Èç¹ûÖ»ÓÐÒ»×éÀ©Õ¹io,
 *      ¿ÉÒÔ½«GPIO_EXPAND_OUT2
 *    ÉèÎªINVALID_GPIO¼´¿É
 * 
 * 3. ¶ÔÓÚ²»Í¬µÄÓ²¼þ°åÇëÒÔºê¸ô¿ª²¢ÅäÖÃºÃÏàÓ¦ºê¶¨Òå
 *
 */
...
/*
* ak39ev33x include 49 gpio(GPI[84:83], GPIO[82:80],
* GPIO[79], GPI[75:70].GPIO[69:64]. 
* GPIO[49]. GPIO[47], CP1O[42:41] GPIO[36:31], GPIO[28:23]
* GPIO[20:19] GPIO[15:13]. GPIO[11:5]. GPIO[2:0])
*/
