...
//#define SDIO_BASE_ADDR                                  SD2_BASE_ADDR /*sdio
//interface*/
...
#define TIMER0_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x0B4)
#define TIMER0_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x0B8)
#define TIMER1_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x0BC)
#define TIMER1_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x0C0)
#define TIMER2_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x0C4)
#define TIMER2_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x0C8)
#define TIMER3_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x0CC)
#define TIMER3_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x0D0)
#define TIMER4_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x0D4)
#define TIMER4_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x0D8)
#define TIMER5_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x1C0)
#define TIMER5_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x1C4)
#define TIMER6_CTRL1_REG       (TIMER_MODULE_BASE_ADDR + 0x1C8)
#define TIMER6_CTRL2_REG       (TIMER_MODULE_BASE_ADDR + 0x1CC)
