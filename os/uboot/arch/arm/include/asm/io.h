...
#define __raw_writel(v, a) do { \
        __arch_putl(v, a); \
        if (((unsigned int)(a) & 0xFFFF0000) == 0x08000000 || \
            ((unsigned int)(a) & 0xFFFF0000) == 0x48000000) { \
...
#define __raw_writel(v, a) do { \
    ...
    if (((unsigned int)(a) & 0xFFFF0000) == 0x08000000 || \
        ((unsigned int)(a) & 0xFFFF0000) == 0x48000000) { \
         printf("**__raw_writel this is 0x0800 or 0x4800** now read 0x00000000\n"); \
         printf("**__raw_writel this is  led 1\n"); \
        __arch_putl(0x40, 0x20170008); \
        __arch_putl(0x40, 0x2017001c); \
        __arch_getl(0x00000000); \
         printf("**__raw_writel this is  led 0\n"); \
        __arch_putl(0x000000, 0x2017001c); \
    } \
} while (0)
