 ...
 * @return void
 */
T_VOID l2_combuf_cpu_frac(T_U32 ram_addr, T_U8 buf_id,
            T_U32 loop, T_U32 remain, T_U8 tran_dir);
 ...
 * @return void
 */
T_VOID l2_combuf_cpu(T_U32 ram_addr, T_U8 buf_id,
            T_U32 tran_byte, T_U8 tran_dir);
 ...
 * @return void
 */
T_VOID l2_combuf_dma(T_U32 ram_addr, T_U8 buf_id,
            T_U32 tran_byte, T_U8 tran_dir, T_BOOL bIntr);
