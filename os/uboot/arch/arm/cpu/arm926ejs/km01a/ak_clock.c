...
#define PLL1_MAX_FREQ					1000000000
#define HCLK_DCLK_DDR2_MAX_FREQ			500000000
#define CPU_MAX_FREQ					900000000
...
void ak3918av100_check_clock(void)
{
