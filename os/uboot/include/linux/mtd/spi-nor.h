...
#define SPINOR_OP_VOLATILE_SR_WREN		0x50	/* Write Enable for Volatile Status Register */
#define SPINOR_OP_RDSR		0x05	/* Read status register */
#define SPINOR_OP_WRSR		0x01	/* Write status register 1 byte */
#define SPINOR_OP_WRCR		0x31	/* Write status register 1 byte */
...
/* Configuration Register bits. */
#define CR_QUAD_EN_SPAN_2		BIT(2)	/* Spansion Quad I/O */
...
struct spi_nor {
	...
	unsigned long 	oob_badblock_offset;
