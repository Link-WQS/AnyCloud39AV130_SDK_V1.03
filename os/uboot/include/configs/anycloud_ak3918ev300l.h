...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "env_version=1.0.00\0" \
    "env_platform=anycloud3918ev300l_nand\0" \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
    ...
    "mem=mem=64M\0" \
    "memsize=memsize=64M\0" \
    "mtdparts=mtdparts=spi0.0:220K@0x0(UBOOT),4K@0x37000(ENV),4K@0x38000(ENVBK),64K@0x39000(DTB),1600K@0x49000(KERNEL),2100K@0x1d9000(ROOTFS),300K@0x3e6000(CONFIG),3900K@0x431000(APP)\0" \
    ...
    "env_platform=anycloud3918ev300l_nor\0" \
