...
#define PART_UBOOTBK_NAME   "UBOOTBK"
...
#ifdef CONFIG_ARCH_AK3750E
#define CONFIG_SYS_SPL_MALLOC_START (CONFIG_SYS_TEXT_BASE - \
                        (CONFIG_ENV_SIZE + 1024*1024))
#define CONFIG_SYS_SPL_MALLOC_SIZE  (CONFIG_ENV_SIZE + 1024*1024)
#else
#define CONFIG_SYS_SPL_MALLOC_START (CONFIG_SYS_TEXT_BASE - \
...
#ifdef CONFIG_ARCH_AK3750E
#define PHYS_SDRAM_1_SIZE   (16 * 1024 * 1024)
#else
...
#ifdef CONFIG_ARCH_AK3750E
#define PHYS_SYS_SDRAM_PROTECT_SIZE       0x00900000 /* 9MB of DRAM */
#else
 ...
 */
#ifdef CONFIG_ARCH_AK3750E
#define CONFIG_SYS_INIT_SP_ADDR     (0x80fd3000 - GENERATED_GBL_DATA_SIZE)
#define CONFIG_LOADADDR     0x80500000  /* loadaddr env var */
#ifdef CONFIG_AK37E_V2
#define FIXED_FDTCONTROLADDR        (CONFIG_SYS_SDRAM_BASE + PHYS_SDRAM_1_SIZE - 0x10000)
#endif
#else
...
/*"mtdparts=mtdparts=spi0.0:400K@0x0(UBOOT),4K@0x64000(ENV),64K@0x65000(DTB),2048K@0x75000(KERNEL)\0" \*/
        ...
        #define CONFIG_MTDPARTS_DEFAULT "mtdparts=nand0.0:128K(SPL),128K(ENV),512K(UBOOT),128K(DTB),2M(KERNEL),20M(ROOTFS),40M(APP),-(CONFIG)"
    #endif
#else
    #ifndef CONFIG_MTDPARTS_DEFAULT
        #define CONFIG_MTDPARTS_DEFAULT "mtdparts=spi0.0:464K(UBOOT),4K(ENV),64K(DTB),2M(KERNEL),2M(ROOTFS),300K(CONFIG),-(APP)"
    #endif
#endif
