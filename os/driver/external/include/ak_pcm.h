...
#define MIXER_OUT_SEL_MAX           \
            (MIXER_OUT_SEL_DAC|MIXER_OUT_SEL_LINEIN|MIXER_OUT_SEL_MIC)
...
#define MIXER_IN_SEL_MAX            \
            (MIXER_IN_SEL_DAC|MIXER_IN_SEL_LINEIN|MIXER_IN_SEL_MIC)
...
struct buf_status{
       long long supply_zero_bytes; /*当前补了多少byte的0数据*/
