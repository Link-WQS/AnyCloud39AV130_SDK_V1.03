...
static char option_hint[][MAX_HINT_LEN] =
{
    ...
    "信号周期 单位是纳秒/ns duty_ns/period_ns 即为占空比 \
        范围为167(6Mhz)-10869565(92Hz)",
    "脉冲持续时间 单位为秒",
    "显示帮助信息",
};
...
static void usage(const char *app)
{
    ...
    ak_print_normal("  %s --pwm_no 0 --duty_ns 5000 --period_ns 10000 \
        --time 5\n", app);
}
