...
#endif
static void ieee80211_sta_abort_worker(struct ieee80211_sub_if_data *sdata,u8 *bssid,
			enum ieee80211_work_type type)
{
	...
	*wait work finished
	*/
	atbm_cancel_work_sync(&local->work_work);
	
	ieee80211_work_abandon(sdata,bssid,type);
...
static void ieee80211_sta_queue_worker(struct ieee80211_work *wk)
{
	...
	*/
	ieee80211_sta_abort_worker(sdata,NULL,IEEE80211_WORK_MAX);
			   ...
			   struct atbm_ieee80211_mgmt *mgmt, size_t len)
{
	...
	ieee80211_set_disassoc(sdata, true, false);
	ieee80211_work_purge(sdata,mgmt->sa,IEEE80211_WORK_MAX,true);
		       ...
		       struct atbm_ieee80211_mgmt *mgmt, size_t len)
{
	...
	case WLAN_AUTH_SAE:
		...
		ieee80211_mgd_auth_rx_authen(wk,mgmt,len);
