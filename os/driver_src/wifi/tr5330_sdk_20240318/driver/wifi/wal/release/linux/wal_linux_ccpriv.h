...
#define WAL_CCPRIV_CMD_MAX_LEN       (WLAN_HMEM_LOCAL_SIZE2 - 4)     /* 私有配置命令字符串最大长度，对应本地内存池一级大小 */

#define WAL_CCPRIV_CMD_NAME_MAX_LEN     80                          /* 字符串中每个单词的最大长度(原20) */
#define WAL_CCPRIV_CMD_VALUE_MAX_LEN    10                          /* 字符串中某个对应变量取值的最大位数 */

#define WAL_CCPRIV_PROC_ENTRY_NAME   "ccpriv"

#define WAL_CCPRIV_HT_MCS_MIN           0
#define WAL_CCPRIV_HT_MCS_MAX           32
#define WAL_CCPRIV_VHT_MCS_MIN          0
#define WAL_CCPRIV_VHT_MCS_MAX          11
#define WAL_CCPRIV_HE_MCS_MIN          0
#define WAL_CCPRIV_HE_MCS_MAX          11
#define WAL_CCPRIV_NSS_MIN              1
#define WAL_CCPRIV_NSS_MAX              4
#define WAL_CCPRIV_CH_NUM               4

#ifdef _PRE_WLAN_FEATURE_ALWAYS_TX
#define WAL_CCPRIV_MAX_DUTY_RATIO       9
#define WAL_CCPRIV_MAX_LONG_SLOT        31
#define WAL_CCPRIV_SHORT_SLOT           9
#define WAL_CCPRIV_MAX_BACK_OFF_TIME    255
#define WAL_CCPRIV_SET_LONG_SLOT_ORDER " 32 0x4001006C 0x019F503C"
#define WAL_CCPRIV_SET_SHORT_SLOT_ORDER " 32 0x4001006C 0x0149503C"
#endif
