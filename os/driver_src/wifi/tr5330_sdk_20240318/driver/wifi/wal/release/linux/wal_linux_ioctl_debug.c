...
{
    osal_u32           off_set;
    osal_char          ac_name[WAL_CCPRIV_CMD_NAME_MAX_LEN] = {0};
...
oal_module_symbol(wal_ccpriv_proc_wr);
#endif
...
osal_u32 uapi_ccpriv_set_sleep(oal_net_device_stru *net_dev, osal_s8 *param)
{
    ...
    if (wal_get_cmd_one_arg(param, cmd, OAL_SIZEOF(cmd), &offset) != TR_SUCCESS) {
...
{
    osal_char name[WAL_CCPRIV_CMD_NAME_MAX_LEN] = {0};
    osal_u32 off_set = 0;
    osal_s32 ret;
    osal_u32 index;
    osal_u32 value;
...
{
    osal_char name[WAL_CCPRIV_CMD_NAME_MAX_LEN];
    osal_u32 off_set = 0;
    osal_u32 ret;
    osal_u32 index;
    osal_u32 value;
