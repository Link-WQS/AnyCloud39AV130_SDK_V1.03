...
osal_void hh503_mac_reg_init(osal_void)
{
    ...
    /* B123新增配置，rssi和normal rx dscr接受hi */
...
/*****************************************************************************
 功能描述  : hh503_mac_retry_en_init
*****************************************************************************/
osal_void hh503_mac_retry_en_init(osal_void)
{
    u_tx_param_val_pilot1 tx_pilot1;
    u_trig_resp_mubar_he_ba_ctrl he_ba_ctrl;

    /* 芯片发送异常时默认设置retry重传位 */
    tx_pilot1.u32 = hal_reg_read(HH503_MAC_CTRL0_BANK_BASE_0x114);
    tx_pilot1.bits._6NgwLPwGjtr_SGow_WL_twCWLwWh_ = 1;
    tx_pilot1.bits._Ct2OwRsOtzlxOR8OGs4SOwmRwQOsmROmo_ = 1;
    hal_reg_write(HH503_MAC_CTRL0_BANK_BASE_0x114, tx_pilot1.u32);

    he_ba_ctrl.u32 = hal_reg_read(HH503_MAC_CTRL2_BANK_BASE_0xD0);
    he_ba_ctrl.bits._Ct2OrsROR8OwmRwQOsmROmo_ = 1;
    hal_reg_write(HH503_MAC_CTRL2_BANK_BASE_0xD0, he_ba_ctrl.u32);
}
...
osal_void hal_dump_count(osal_void)
{
    stats_reg_stru reg_table[] = {
        /* MAC Tx stats */
        {"MAC", "TX_TR_PRI_MPDU_CNT     ", HH503_MAC_RD1_BANK_BASE_0x24},
        ...
        {"MAC", "TX_TR_PRI_RETRY_CNT    ", HH503_MAC_RD1_BANK_BASE_0x34},
...
static osal_void hal_dump_cfg(osal_void)
{
    stats_reg_stru reg_table[] = {
        ...
        {"MAC", "TR_PRI_ADDRESS_STATUS  ", HH503_MAC_RD0_BANK_BASE_0x44},
