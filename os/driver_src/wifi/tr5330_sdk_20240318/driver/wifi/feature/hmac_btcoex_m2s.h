...
static osal_u32 hmac_btcoex_m2s_init_weakref(osal_void)
    __attribute__ ((weakref("hmac_btcoex_m2s_init"), used));
static osal_void hmac_btcoex_m2s_deinit_weakref(osal_void)
    __attribute__ ((weakref("hmac_btcoex_m2s_deinit"), used));
