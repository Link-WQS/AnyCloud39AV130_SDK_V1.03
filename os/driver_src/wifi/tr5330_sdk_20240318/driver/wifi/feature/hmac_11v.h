...
typedef osal_void (*hmac_11v_set_bss_transition_cb)(mac_user_cap_info_stru *cap_info, osal_u8 *cap);
...
typedef osal_void (*hmac_11v_trigger_roam_check_cb)(hmac_roam_info_stru *roam_info, hmac_vap_stru *hmac_vap);
