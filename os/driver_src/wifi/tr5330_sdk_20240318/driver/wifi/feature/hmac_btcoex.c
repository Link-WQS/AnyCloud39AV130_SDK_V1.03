...
OSAL_STATIC osal_u32 hmac_btcoex_hal_set_aging_time(const hmac_vap_stru *hmac_vap, int *aging_time)
{
...
osal_u32 hmac_btcoex_init(osal_void)
{
    ...
    ret |= hmac_btcoex_ba_init_weakref();
    ret |= hmac_btcoex_m2s_init_weakref();
    ret |= hmac_btcoex_notify_init_weakref();
    ret |= hmac_btcoex_ps_init_weakref();
    if (ret != OAL_SUCC) {
...
osal_void hmac_btcoex_deinit(osal_void)
{
    ...
    hmac_btcoex_ba_deinit_weakref();
    hmac_btcoex_m2s_deinit_weakref();
    hmac_btcoex_notify_deinit_weakref();
    hmac_btcoex_ps_deinit_weakref();
}
