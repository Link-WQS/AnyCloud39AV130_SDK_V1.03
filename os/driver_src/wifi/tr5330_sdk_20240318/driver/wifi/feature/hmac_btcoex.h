...
typedef osal_void (*hmac_btcoex_check_rx_same_baw_start_from_addba_req_etc_cb)(hmac_vap_stru *hmac_vap,
    hmac_user_stru *hmac_user, mac_ieee80211_frame_stru *frame_hdr, osal_u8 *action);
...
typedef osal_void (*hmac_btcoex_hal_set_btcoex_wifi_status_cb)(hmac_vap_stru *hmac_vap, osal_u32 status);
