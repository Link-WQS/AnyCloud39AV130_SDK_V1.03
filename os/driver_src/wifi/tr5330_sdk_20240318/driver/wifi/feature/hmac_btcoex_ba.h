...
static osal_u32 hmac_btcoex_ba_init_weakref(osal_void) __attribute__ ((weakref("hmac_btcoex_ba_init"), used));
static osal_void hmac_btcoex_ba_deinit_weakref(osal_void)
    __attribute__ ((weakref("hmac_btcoex_ba_deinit"), used));
