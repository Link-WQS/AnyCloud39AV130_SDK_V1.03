...
static osal_u32 hmac_btcoex_ps_init_weakref(osal_void) __attribute__ ((weakref("hmac_btcoex_ps_init"), used));
static osal_void hmac_btcoex_ps_deinit_weakref(osal_void)
    __attribute__ ((weakref("hmac_btcoex_ps_deinit"), used));
