...
typedef osal_void (*hmac_11r_set_authentication_mode_cb)(hmac_vap_stru *hmac_vap, mac_conn_security_stru *conn_sec);
typedef osal_void (*hmac_11r_mib_init_cfg_cb)(hmac_vap_stru *hmac_vap, mac_conn_security_stru *conn_sec,
...
typedef osal_u32 (*hmac_11r_roam_connect_start_etc_cb)(hmac_vap_stru *hmac_vap, hmac_roam_info_stru *roam_info,
    mac_bss_dscr_stru *bss_dscr);
typedef osal_void (*hmac_11r_roam_connect_to_bss_cb)(hmac_vap_stru *hmac_vap, hmac_roam_info_stru *roam_info,
