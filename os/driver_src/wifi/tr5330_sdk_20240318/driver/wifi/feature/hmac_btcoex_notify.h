...
static osal_u32 hmac_btcoex_notify_init_weakref(osal_void)
    __attribute__ ((weakref("hmac_btcoex_notify_init"), used));
static osal_void hmac_btcoex_notify_deinit_weakref(osal_void)
    __attribute__ ((weakref("hmac_btcoex_notify_deinit"), used));
