...
typedef struct {
    ...
    osal_task* diag_tx_proc_task; // similar with 86's diag_proc_task, diag_tcp_task_id;
    osal_semaphore diag_tx_sem; // similar with 86's diag_main_sem;
    osal_bool tx_task_break_flag; // similar with 86's thread_break_flag;
} zdiag_ctx_stru;
