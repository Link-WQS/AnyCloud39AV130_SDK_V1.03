...
#define HCC_SDIO_VENDOR_ID_TR5330                    0x12D1      /* VENDOR tr5330 */
#define HCC_SDIO_PRODUCT_ID_TR5330                   0x0073      /* Product tr5330 */
...
static struct sdio_device_id TD_CONST sdio_ids[] = {
    ...
    { SDIO_DEVICE(HCC_SDIO_VENDOR_ID_TR5330, HCC_SDIO_PRODUCT_ID_TR5330) },
    {},
};
...
td_u32 sdio_func_max_req_size(struct oal_sdio *pst_tr_sdio)
{
    td_u32 max_blocks;
    td_u32 size, size_device;

    if (OAL_WARN_ON(pst_tr_sdio == TD_NULL)) {
        oal_sdio_log(BUS_LOG_ERR, "pst_tr_sdio is null");
        return 0;
    };
    /* host transer limit */
    /* Blocks per command is limited by host count, host transfer
     * size and the maximum for IO_RW_EXTENDED of 511 blocks. */
    max_blocks = osal_min(sdio_func_host_max_blk_num(pst_tr_sdio->func), 511u);
    size = max_blocks * HCC_SDIO_BLOCK_SIZE;
    size = osal_min(size, sdio_func_host_max_req_size(pst_tr_sdio->func));
