...
#define FW_ROMBIN_DOWNLOAD_CMD      "1,0x106400,/etc/tr5330/tr5330_rom.bin"
...
#define FW_BIN_DOWNLOAD_CMD         "1,0x400000,"CONFIG_FIRMWARE_BIN_PATH
#define FW_ROMBIN_DOWNLOAD_CMD      "1,0x106400,/jffs0/tr5330_rom.bin"
#define FW_WIFICALI_DOWNLOAD_CMD    "1,0x430000,"CONFIG_FIRMWARE_WIFICALI_PATH
#define FW_BSLECALI_DOWNLOAD_CMD    "1,0x440000,"CONFIG_FIRMWARE_BSLECALI_PATH
#endif
...
osal_s32 firmware_cmd_quit_func(void)
{
    ...
    l_ret = firmware_send_and_recv_expect_result_func(buf, l_len, MSG_FROM_DEV_QUIT_OK);
    osal_kfree(buf);
...
{
    osal_s32 max_firmware_file_len = MAX_FIRMWARE_FILE_TX_BUF_LEN;
    hcc_bus *pst_bus;
...
#if defined(_PRE_OS_VERSION) && defined(_PRE_OS_VERSION_LINUX) && (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    g_fw_data_buf = (osal_u8 *)oal_memtry_alloc(uapi_min(pst_bus->cap_max_trans_size, max_firmware_file_len),
