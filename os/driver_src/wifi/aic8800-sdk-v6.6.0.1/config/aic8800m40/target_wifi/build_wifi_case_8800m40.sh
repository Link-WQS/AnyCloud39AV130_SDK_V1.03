...
python ../../../tools/scons.py -u . PRODUCT=host-wifi PLF=aic8800m40 BT=armgcc_4_8 BUILD_CMD="$0 $*" TGT_MODE=wifi BAND5G=on SOFTAP=on IPERF=on PING=on CHKSUM=off WIFI_RAM_VER=on HEAP_SIZE=0x14000 FHOST_APP=console $opt
