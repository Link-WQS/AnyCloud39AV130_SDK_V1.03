...
__STATIC_INLINE void pwrctrl_pwr_ctrl_delay1_set(uint32_t delay)
{
    AIC_PWRCTRL->pwr_ctrl_delay1 = 0xFFFFFFFF;
}
__STATIC_INLINE void pwrctrl_pwr_ctrl_delay2_set(uint32_t delay)
{
    uint32_t local_val = AIC_PWRCTRL->pwr_ctrl_delay2 & ~(PWR_CTRL_PWR_CTRL_STATE_DELAY_MASK);
    AIC_PWRCTRL->pwr_ctrl_delay2 = local_val | PWR_CTRL_PWR_CTRL_STATE_DELAY(delay);
}
