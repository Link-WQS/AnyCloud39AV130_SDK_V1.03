...
#define AICBT_CHIP_ID_U02H                     0x01
#define AICBT_PATCH_BASE_ADDR_U02H             0x10a42c
#define AICBT_ADID_RAM_BASE_ADDR_U02H          0x00100f60
#define AICBT_ADID_ROM_BASE_ADDR_U02H          0x000ae624
#define AICBT_ADID_SIZE_U02H                   0x5c4

#define AICBT_PATCH_DATA_PTR_U02H              (uint8_t *)(&fw_patch_u02h[0])
#define AICBT_PATCH_DATA_SIZE_U02H             AICBT_FW_PATCH_U02H_SIZE
#define AICBT_PATCH_TABLE_PTR_U02H             (uint8_t *)(&fw_patch_table_u02h[0])
#define AICBT_PATCH_TABLE_SIZE_U02H            AICBT_FW_PATCH_TABLE_U02H_SIZE
