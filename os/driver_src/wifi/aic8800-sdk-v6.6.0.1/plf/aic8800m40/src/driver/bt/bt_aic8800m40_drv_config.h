...
#include "fw_patch_u04.h"
#include "fw_patch_table_u04.h"
...
#define AICBT_CHIP_ID_U04                      0x01
#define AICBT_PATCH_BASE_ADDR_U04              0x1D8000
#define AICBT_ADID_RAM_BASE_ADDR_U04           0x00201a00
#define AICBT_ADID_ROM_BASE_ADDR_U04           0x000fad70
#define AICBT_ADID_SIZE_U04                    0x6e0
#define AICBT_PATCH_DATA_PTR_U04               (uint8_t *)(&fw_patch_u04[0])
#define AICBT_PATCH_DATA_SIZE_U04              AICBT_FW_PATCH_U04_SIZE
#define AICBT_PATCH_TABLE_PTR_U04              (uint8_t *)(&fw_patch_table_u04[0])
#define AICBT_PATCH_TABLE_SIZE_U04             AICBT_FW_PATCH_TABLE_U04_SIZE
