...
typedef struct {
  ...
  union {
    ...
    struct {
      ...
      __IO uint32_t CHIPINFO;   /* 0x184: Chip info: temp or hw status */
      __IO uint32_t RESERVED[2];/* 0x188: Reserved */
    };
  };
...
#define ASC_CHIPINFO_TEMP_LSB           (0)
#define ASC_CHIPINFO_TEMP_WIDTH         (8)
#define ASC_CHIPINFO_TEMP_MASK          (((0x01UL << ASC_CHIPINFO_TEMP_WIDTH) - 1) << ASC_CHIPINFO_TEMP_LSB)
#define ASC_CHIPINFO_LPTMR_INITED_POS   (8)
#define ASC_CHIPINFO_LPTMR_INITED_BIT   (0x01UL << ASC_CHIPINFO_LPTMR_INITED_POS)
#define ASC_CHIPINFO_VRTC1_CALIBED_POS  (9)
#define ASC_CHIPINFO_VRTC1_CALIBED_BIT  (0x01UL << ASC_CHIPINFO_VRTC1_CALIBED_POS)
...
__STATIC_INLINE uint32_t aonsysctrl_chipinfo_get(void)
{
    return AIC_AONSYSCTRL->CHIPINFO;
}

__STATIC_INLINE void aonsysctrl_chipinfo_set(uint32_t chipinfo)
{
    AIC_AONSYSCTRL->CHIPINFO = chipinfo;
}

__STATIC_INLINE int8_t aonsysctrl_chipinfo_temp_getf(void)
{
    return (int8_t)((AIC_AONSYSCTRL->CHIPINFO & ASC_CHIPINFO_TEMP_MASK) >> ASC_CHIPINFO_TEMP_LSB);
}

__STATIC_INLINE void aonsysctrl_chipinfo_temp_setf(int8_t degree)
{
    uint32_t local_val = AIC_AONSYSCTRL->CHIPINFO & ~ASC_CHIPINFO_TEMP_MASK;
    AIC_AONSYSCTRL->CHIPINFO = local_val | (((uint32_t)degree << ASC_CHIPINFO_TEMP_LSB) & ASC_CHIPINFO_TEMP_MASK);
}

__STATIC_INLINE uint8_t pwrctrl_chipinfo_lptmr_inited_getb(void)
{
    return (AIC_AONSYSCTRL->CHIPINFO & ASC_CHIPINFO_LPTMR_INITED_BIT) >> ASC_CHIPINFO_LPTMR_INITED_POS;
}

__STATIC_INLINE void pwrctrl_chipinfo_lptmr_inited_setb(void)
{
    AIC_AONSYSCTRL->CHIPINFO |=  ASC_CHIPINFO_LPTMR_INITED_BIT;
}

__STATIC_INLINE void pwrctrl_chipinfo_lptmr_inited_clrb(void)
{
    AIC_AONSYSCTRL->CHIPINFO &= ~ASC_CHIPINFO_LPTMR_INITED_BIT;
}

__STATIC_INLINE uint8_t pwrctrl_chipinfo_vrtc1_calibed_getb(void)
{
    return (AIC_AONSYSCTRL->CHIPINFO & ASC_CHIPINFO_VRTC1_CALIBED_BIT) >> ASC_CHIPINFO_VRTC1_CALIBED_POS;
}

__STATIC_INLINE void pwrctrl_chipinfo_vrtc1_calibed_setb(void)
{
    AIC_AONSYSCTRL->CHIPINFO |=  ASC_CHIPINFO_VRTC1_CALIBED_BIT;
}

__STATIC_INLINE void pwrctrl_chipinfo_vrtc1_calibed_clrb(void)
{
    AIC_AONSYSCTRL->CHIPINFO &= ~ASC_CHIPINFO_VRTC1_CALIBED_BIT;
}
...
__STATIC_INLINE uint8_t pwrctrl_btcore_sleep_src_getf(void)
{
    return ((AIC_PWRCTRL->bt_core_pwr_ctrl & PWR_CTRL_BT_CORE_SLP_SRC_EN_MASK) >> PWR_CTRL_BT_CORE_SLP_SRC_EN_LSB);
}

__STATIC_INLINE void pwrctrl_btcore_sleep_src_setf(uint8_t sleep_src)
{
    uint32_t local_val = AIC_PWRCTRL->bt_core_pwr_ctrl & ~PWR_CTRL_BT_CORE_SLP_SRC_EN_MASK;
    AIC_PWRCTRL->bt_core_pwr_ctrl = local_val | PWR_CTRL_BT_CORE_SLP_SRC_EN(sleep_src);
}
...
{
    return (AIC_PWRCTRL->bt_core_pwr_ctrl & PWR_CTRL_PON_BT_CORE) >> PWR_CTRL_PON_BT_CORE_POS;
}
...
{
    return (AIC_PWRCTRL->bt_core_pwr_ctrl & PWR_CTRL_POFF_BT_CORE) >> PWR_CTRL_POFF_BT_CORE_POS;
}
...
__STATIC_INLINE void pwrctrl_btcore_awake_soft_req_clrb(void)
{
    AIC_PWRCTRL->bt_core_pwr_ctrl &= ~PWR_CTRL_BT_CORE_SOFT_WAKEUP_REQ;
}
...
{
    AIC_PWRCTRL->bt_core_pwr_ctrl |=  PWR_CTRL_BT_CORE_SOFT_WAKEUP_REQ_TO_BT;
}
...
{
    return (AIC_PWRCTRL->wifi_core_pwr_ctrl & PWR_CTRL_PON_WIFI_CORE) >> PWR_CTRL_PON_WIFI_CORE_POS;
}
...
{
    return (AIC_PWRCTRL->wifi_core_pwr_ctrl & PWR_CTRL_POFF_WIFI_CORE) >> PWR_CTRL_POFF_WIFI_CORE_POS;
}
