...
enum APPLICATION_CMD
{
    ...
    APP_CMD_SOC_POWER_OFF   = 15,
    APP_CMD_BLEWIFI_CFG     = 16,
    APP_CMD_NET_WAKEUP_CFG  = 17,
    APP_CMD_HOSTIF_RESET    = 18,
};
...
enum CUSTOM_CMD_TAG
{
    ...
    CUST_CMD_SOC_POWER_OFF_REQ,
    CUST_CMD_BLEWIFI_CFG_REQ,
    CUST_CMD_NET_WAKEUP_CFG_REQ,
    CUST_CMD_HOSTIF_RESET_REQ,
    CUST_CMD_HOST_STOP_KEEP_ALIVE_REQ,
    CUST_CMD_MAX
};
...
#define AKM_BUF_MAX (10)
#define CIPHER_BUF_MAX (10)
...
struct custom_msg_start_ap_req
{
    ...
    u8_l pw[AP_PSWD_BUF_MAX];
    u8_l channel;
    u8_l akm[AKM_BUF_MAX];
    u8_l unicast_cipher[CIPHER_BUF_MAX];
    u8_l group_cipher[CIPHER_BUF_MAX];
};
...
struct custom_msg_net_wakeup_cfg_req
{
    struct custom_msg_hdr hdr;
    u8_l server_ip[64];
    u16_l server_port;
    u32_l keepalive_interval_ms;
    u8_l keepalive_msg[64];
};
...
typedef struct _aicwf_custom_msg_app_cmd {
    ...
    struct custom_msg_net_wakeup_cfg_req net_wakeup_cfg_req;
