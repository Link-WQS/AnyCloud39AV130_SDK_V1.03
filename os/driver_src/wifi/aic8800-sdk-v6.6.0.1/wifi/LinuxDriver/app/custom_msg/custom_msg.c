...
char *str_help = "usage: custom_msg vnet0 [mode] <arg1> <arg2> <arg3>\r\n"
                 ...
                 "custom_msg vnet0 9 ssid password band [channel] [akm unicast_cipher group_cipher] - start ap\r\n"
                 "                   -- band = <2.4G/5G>\r\n"
                 "                   -- channel = 1~14(2.4G),5G(depend on fhost_chan)\r\n"
                 "                   -- akm = Authentication and Key Management suite, WPA/PSK, WPA2/PSK, WPA3/PSK\r\n"
                 "                   -- unicast_cipher = unicast cipher suite, CCMP/TKIP\r\n"
                 "                   -- group_cipher = group cipher suite, CCMP/TKIP\r\n"
                 ...
                 "custom_msg vnet0 15                       - soc power off\r\n"
                 "custom_msg vnet0 16                       - run blewifi_cfg\r\n"
                 "custom_msg vnet0 17                       - net wakeup config\r\n"
                 "custom_msg vnet0 18                       - hostif reset\r\n"
                 "------------------------\r\n"
