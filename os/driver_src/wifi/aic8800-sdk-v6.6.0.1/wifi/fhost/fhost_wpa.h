...
/**
 * wpa_supplicant connect_result.
 */
enum fhost_wpa_connect_result
{
    /// connect successfully
    FHOST_WPA_CONN_RES_SUCCESS,
    /// connect failed, wrong passwd
    FHOST_WPA_CONN_RES_PSK_MISMATCH,
};
...
int fhost_wpa_cfg_str_escape(char *in_out, int len);

int fhost_wpa_cfg_str_unescape(char *in_out, int len);

int fhost_wpa_get_status(int fhost_vif_idx);
