...
void fhost_config_txpwr_loss_value_set(int value)
{
...
void fhost_config_txpwrloss_ctrl_set(int8_t value)
{
...
void fhost_config_dynamic_txpwr_timer_handler(TimerHandle_t xTimer)
{
