...
void ipc_host_emb_state_set(enum ipc_emb_state_e state);
#endif
#if NX_UF_EN
...
int get_wifi_disconnected_sleep_allow_flag(void);
void wifi_fw_powerdown(void);
 ...
 * @return      AIC8800
                1: ready, 0: not ready
                AIC8800MC/AIC8800M40
                IPC_EMB_START: ready, OTHERS: not ready
 ****************************************************************************************
 */
