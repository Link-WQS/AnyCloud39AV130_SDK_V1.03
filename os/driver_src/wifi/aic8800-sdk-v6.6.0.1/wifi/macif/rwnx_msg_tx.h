...
int rwnx_send_roc_req(int fvif_idx, int freq, uint32_t duration_ms, struct mm_remain_on_channel_cfm *roc_cfm);
int rwnx_send_cancel_roc_req(void);
...
int rwnx_set_rf_config_req(uint8_t ofst, uint8_t sel, uint8_t *tbl, int len);
#endif
...
#if (PLF_AIC8800M40)
int rwnx_send_txpwr_lvl_adj_req_8800m40(void);
#endif
#if (PLF_AIC8800MC)
...
#endif
#if (PLF_AIC8800M40)
int rwnx_send_vendor_swconfig_req(void *config_param, void *result_out);
#endif
