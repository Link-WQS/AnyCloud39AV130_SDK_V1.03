...
void app_udfs_db_cfg_init(void)
{
    ...
    app_udfs_db_cfg[0].svc_perm = PERM(SVC_AUTH, UNAUTH)|PERM(SVC_MI, ENABLE);//PERM(SVC_AUTH, UNAUTH);
    ...
    app_udfs_db_cfg[1].svc_perm = PERM(SVC_AUTH, UNAUTH)|PERM(SVC_MI, ENABLE);//PERM(SVC_AUTH, UNAUTH);
