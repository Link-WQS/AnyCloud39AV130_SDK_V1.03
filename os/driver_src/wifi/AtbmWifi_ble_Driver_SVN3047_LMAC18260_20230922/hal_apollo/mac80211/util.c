...
static void ieee80211_event_csa_done(struct ieee80211_sub_if_data *sdata,u32 status)
{
	...
	csa_mlme->state = status ? IEEE80211_CSA_MLME_STATE_FINISHED : IEEE80211_CSA_MLME_STATE_FAIL;
