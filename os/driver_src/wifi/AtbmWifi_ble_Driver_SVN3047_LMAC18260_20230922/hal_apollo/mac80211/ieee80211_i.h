...
enum ieee80211_csa_mlme_state{
	...
	IEEE80211_CSA_MLME_STATE_DELAY,
...
enum ieee80211_work_type {
	...
	IEEE80211_WORK_STA_CHANNEL_SWITCH,
	/*
	*keep must
	*/
	IEEE80211_WORK_MAX,
...
#ifdef CONFIG_ATBM_AP_SUPPORT_CSA
	struct ieee80211_sub_if_data *csa_sdata;
	struct atbm_delayed_work csa_work;
	unsigned long csa;
#endif
};
