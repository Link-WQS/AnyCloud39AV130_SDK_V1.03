...
/// IPC EMB2APP wifi assert notify
#define IPC_IRQ_E2A_WIFI_ASSERT_NOTIFY  CO_BIT(11)
...
/// IPC EMB2APP interrupt mask option 1#
#if defined(CFG_DEVICE_IPC)
#define IPC_IRQ_WIFI_E2A_MASK_OPT1  IPC_IRQ_E2A_CUSTOM_MSG
#else
#define IPC_IRQ_WIFI_E2A_MASK_OPT1  0
#endif

/// IPC EMB2APP interrupt mask option 2#
#if (PLF_AIC8800M40)
#define IPC_IRQ_WIFI_E2A_MASK_OPT2  IPC_IRQ_E2A_WIFI_ASSERT_NOTIFY
#else
#define IPC_IRQ_WIFI_E2A_MASK_OPT2  0
#endif
...
#define IPC_IRQ_WIFI_E2A_ALL    ( IPC_IRQ_E2A_RXDESC        \
                                ...
                                | IPC_IRQ_WIFI_E2A_MASK_OPT1 | IPC_IRQ_WIFI_E2A_MASK_OPT2 \
