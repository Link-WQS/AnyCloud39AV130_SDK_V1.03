...
typedef void (*host_usb_suspend_handler_t)(void);

typedef void (*host_sdio_init_timeout_callback_t)(void);
...
void host_if_sdio_init_timeout_callback_register(host_sdio_init_timeout_callback_t callback);
