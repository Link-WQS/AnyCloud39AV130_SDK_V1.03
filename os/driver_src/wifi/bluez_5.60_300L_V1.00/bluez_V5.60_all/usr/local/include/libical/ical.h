...
typedef enum icalvalue_kind {
   ICAL_ANY_VALUE=5000,
    ICAL_RECUR_VALUE=5001,
    ICAL_DATE_VALUE=5002,
    ICAL_DURATION_VALUE=5003,
    ICAL_BOOLEAN_VALUE=5004,
    ICAL_DATETIME_VALUE=5005,
    ICAL_URI_VALUE=5006,
    ICAL_ATTACH_VALUE=5007,
    ICAL_METHOD_VALUE=5008,
    ICAL_STATUS_VALUE=5009,
    ICAL_PERIOD_VALUE=5010,
    ICAL_QUERYLEVEL_VALUE=5011,
    ICAL_TRANSP_VALUE=5012,
    ICAL_UTCOFFSET_VALUE=5013,
    ICAL_QUERY_VALUE=5014,
    ICAL_TEXT_VALUE=5015,
    ICAL_CMD_VALUE=5016,
    ICAL_ACTION_VALUE=5017,
    ICAL_DATETIMEPERIOD_VALUE=5018,
    ICAL_GEO_VALUE=5019,
    ICAL_STRING_VALUE=5020,
    ICAL_TRIGGER_VALUE=5021,
    ICAL_BINARY_VALUE=5022,
    ICAL_INTEGER_VALUE=5023,
    ICAL_XLICCLASS_VALUE=5024,
    ICAL_FLOAT_VALUE=5025,
    ICAL_REQUESTSTATUS_VALUE=5026,
    ICAL_CLASS_VALUE=5027,
    ICAL_CARLEVEL_VALUE=5028,
    ICAL_CALADDRESS_VALUE=5029,
    ICAL_X_VALUE=5030,
   ICAL_NO_VALUE=5031
} icalvalue_kind ;
