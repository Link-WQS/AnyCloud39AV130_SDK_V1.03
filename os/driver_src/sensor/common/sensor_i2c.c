 ...
 */
static int i2c_write_reg2_value1(
    const struct i2c_client* client, int reg, int value)
{
    unsigned char msg[3];
 ...
 * RETURN:  0-success, others-fail
 */
static int i2c_write_reg2_value2(
    const struct i2c_client* client, int reg, int value)
{
    unsigned char msg[4];
 ...
 * RETURN:  0-success, others-fail
 */
static int i2c_write_reg1_value1(
    const struct i2c_client* client, int reg, int value)
{
 ...
 * RETURN:  0-success, others-fail
 */
static int i2c_write_reg1_value2(
    const struct i2c_client* client, int reg, int value)
{
