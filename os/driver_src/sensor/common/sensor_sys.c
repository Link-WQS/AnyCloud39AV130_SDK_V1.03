...
static struct kobj_attribute sensor_id_obj
    = __ATTR(sensor_id, S_IRUGO, sensor_id_read, NULL);
static struct kobj_attribute sensor_if_obj
    = __ATTR(sensor_if, S_IRUGO, sensor_if_read, NULL);
