...
//param
extern struct completion frame_done;
//video process
int video_daemon_init(int fastfs_len,int conf_len);


//crypto
int md5_mod_init(void);
int aes_init(void);
int arc4_init(void);
int crc32c_mod_init(void);
int crypto_null_mod_init(void);
int sha1_generic_mod_init(void);
//misc
//int ak_serial_modinit(void);
int slab_sysfs_init(void);
//int init_jffs2_fs(void);
//int init_fat_fs(void);

//fast modules init
//int venc_adapter_init(void);
//int ak_venc_bridge_init(void);
//int sys_sensor_init_func(void);

//get fast modules init param
...
int sys_kinit_module(const char *module);
int sys_kinit_mod(char *ptr, int size, const char *uargs);
//int sys_sensor_param_func(int dev,int param, void *value);
//int get_ae_fast_def(void);
...
//int ak_isp_get_ae_run_info(void *input, void *output);
//int ak_isp_set_ae_info(void *input, void *param);
//int ak_isp_get_awb_run_info(void *input, void *output);
//int ak_isp_get_raw_hist(void *input);
//int fast_isp_all_done_work(void *arg,int input_id);
