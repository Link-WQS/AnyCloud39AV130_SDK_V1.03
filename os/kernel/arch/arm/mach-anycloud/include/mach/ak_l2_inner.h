...
#define L2_DMA_REQ_FRAC_DMA_L2_ADDR_ST 1 //ST:START
...
#define L2_COMMON_BUF_CFG_BUF_DMA_VLD_ST 0
...
#define L2_UART_BUF_CFG_CPU_BUF_NUM_ST 4
#define L2_UART_BUF_CFG_CPU_BUF_NUM_MASK                                       \
    (0xF << L2_UART_BUF_CFG_CPU_BUF_NUM_ST)
#define L2_UART_BUF_CFG_CPU_BUF_SEL_ST 0
#define L2_UART_BUF_CFG_CPU_BUF_SEL_MASK                                       \
    (0x7 << L2_UART_BUF_CFG_CPU_BUF_SEL_ST)

#define L2_DMA_INTR_ENABLE_BUF_START      9
#define L2_DMA_INTR_ENABLE_UART_BUF_ST 1
...
#undef L2_UART_BUFFER_NUM
#define L2_UART_BUFFER_NUM   6
#endif
...
#if 0
#if defined(CONFIG_MACH_KM01A) || defined(CONFIG_MACH_AK3918AV130)
#undef L2_USB_HOST_BUFFER_INDEX
#endif
#endif
...
typedef enum {
    ...
    ADDR_PDM, /* PDM interface */
    ADDR_RESERVED3,
    ADDR_ADC, /* ADC interface */
} l2_device_t;
#else
typedef enum {
...
#define L2_UART_BUF_START_ID                                                   \
    L2_COMMON_BUFFER_NUM /* UART used buffer ID from 8 */
...
{
    REG32(RESET_MODULE_REG) |= (L2_BUFFER_RESET);
    REG32(RESET_MODULE_REG) &= ~(L2_BUFFER_RESET);
