...
#define UART_STOPBIT_TIMEOUT    (0x18)
    ...
    #define UART_DIV_FACTOR     (0x1C)
#endif /* CONFIG_MACH_AK3918AV100 || CONFIG_MACH_AK3918EV300L */
...
// read only
#define UARTN_RX_TH_CNT(rvalue)             (((rvalue) >> 12) & 0xFFF)
// read only
#define UARTN_TX_TH_CNT(rvalue)             (((rvalue) >> 24) & 0x1F)
// read only
#define UARTN_BFIFO_BYTE_NUM(rvalue)        (((rvalue) >> 29) & 0x03)
#define UARTN_RX_START                      (1UL <<31)
