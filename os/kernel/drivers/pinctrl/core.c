...
static struct pinctrl *create_pinctrl(struct device *dev)
{
	...
	for_each_maps(maps_node, i, map) {
		...
		//reduce device_probe pinctrl delay
		else if (strcmp("21100000.spi0", devname)==0 || strcmp("ion", devname)==0 /*|| strcmp("21200000.vi0", devname)==0*/)
		{
		 #ifdef CONFIG_AK_DVP_INTERFACE
		 if( strcmp("21200000.vi0", devname)==0 )
		 ;
		 else
		 #endif
		 break;
