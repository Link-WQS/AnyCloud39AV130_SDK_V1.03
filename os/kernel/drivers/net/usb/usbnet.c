...
//#define SUPPORTS_4G_MODULES
#ifndef SUPPORTS_4G_MODULES
#define SUPPORTS_USB_NET 1
#else
#define SUPPORTS_USB_NET 0
#endif
...
#if SUPPORTS_USB_NET //change for 4g module:disable interrupt urb submit && polling
...
#if SUPPORTS_USB_NET    //add for 4g module:disable interrupt urb submit
	if (dev->interrupt) {
