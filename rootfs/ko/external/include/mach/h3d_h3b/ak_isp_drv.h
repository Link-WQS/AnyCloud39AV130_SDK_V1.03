...
typedef struct ak_isp_nr2 {
    ...
    // unsigned short ynr_intensity_slop;／／ynr_intensity_slop =
    // (ynr_intensity1-ynr_intensity2 )*1024/(ynr_mf_th2-ynr_mf_th1);
...
typedef struct ak_isp_3d_nr {
    ...
    // unsigned short        uvlp_kslop;     //[0, 127]
    // uvlp_kslop=(uvlp_k1-uvlp_k2 )*1024/(t_mf_th2-t_mf_th1);
    unsigned short t_uv_th1; //[0, 255],default:48(GUI edit)
    unsigned short t_uv_th2; //[0, 255],default:16(GUI edit)
    // unsigned short        t_uv_th_slop;       //[0, 255]  t_uv_th_slop =
    // (t_uv_th1-t_uv_th2 )*1024/(t_mf_th2-t_mf_th1);
    ...
    // unsigned short        ylp_kslop;      //[0, 255]  ylp_kslop =
    // (ylp_k1-ylp_k2 )*1024/(t_mf_th2-t_mf_th1);
    unsigned short t_y_th1; //[0, 255],default:48(GUI edit)
    unsigned short t_y_th2; //[0, 255],default:16(GUI edit)
    // unsigned short        t_y_th_slop;        //[0, 255]  t_y_th_slop =
    // (t_y_th1-t_y_th2 )*1024/(t_mf_th2-t_mf_th1);
...
typedef struct ak_isp_sharp {
    ...
    // unsigned short sharp_intensity_slop;  sharp_intensity_slop =
    // (sharp_intensity1-sharp_intensity2 )*1024/(sharp_mf_th2-sharp_mf_th1);
 ...
 * @return: int
 */
int ak_isp_set_misc_attr_ex(
    void* isp_struct, int oneline, int fsden, int hblank, int fsdnum);
 ...
 * @return: int
 */
int isp_set_pp_frame_ctrl(void* isp_struct, int ch1_frame_ctrl,
    int ch2_frame_ctrl, int ch3_frame_ctrl);
 ...
 * @param [out] *p_contrast: contrast attr
 */
int ak_isp_vpp_set_osd_color_table_attr(
    void* isp_struct, AK_ISP_OSD_COLOR_TABLE_ATTR* p_isp_color_table);
...
/**
 * @brief: ak_isp_vpp_set_sub_channel_osd_mem_attr
 * @param [out] *p_mem: OSD_MEM_ATTR
 */    
 ...
 */
int ak_isp_vp_get_raw_hist_stat_info(
    void* isp_struct, AK_ISP_RAW_HIST_STAT_INFO* p_raw_hist_stat);
 ...
 */
int ak_isp_vp_get_rgb_hist_stat_info(
    void* isp_struct, AK_ISP_RGB_HIST_STAT_INFO* p_rgb_hist_stat);

/**
 * @brief: get yuv hist   running info
 * @author: xiepenghe
 * @date: 2016-5-06
 * @param [out] *p_yuv_hist_stat:  yuv hist info  param
 */
int ak_isp_vp_get_yuv_hist_stat_info(
    void* isp_struct, AK_ISP_YUV_HIST_STAT_INFO* p_yuv_hist_stat);

/**
 * @brief: set rgb hist   running info
 * @author: xiepenghe
 * @date: 2016-5-06
 * @param [out] *p_rgb_hist_stat:  yuv hist info  param
 */
int ak_isp_vp_set_rgb_hist_attr(
    void* isp_struct, AK_ISP_RGB_HIST_ATTR* p_rgb_hist);
 ...
 * @param [out] *p_rgb_hist_stat:  yuv hist info  param
 */
int ak_isp_vp_get_rgb_hist_attr(
    void* isp_struct, AK_ISP_RGB_HIST_ATTR* p_rgb_hist);
 ...
 * @param [out] *p_yuv_hist_stat:  yuv hist info  param
 */
int ak_isp_vp_set_yuv_hist_attr(
    void* isp_struct, AK_ISP_YUV_HIST_ATTR* p_yuv_hist);
 ...
 * @param [out] *p_yuv_hist_stat:  yuv hist info  param
 */
int ak_isp_vp_get_yuv_hist_attr(
    void* isp_struct, AK_ISP_YUV_HIST_ATTR* p_yuv_hist);
...
/**
 * @brief: set raw_hist_attr
 * @author: xiepenghe
 * @date: 2016-5-06
 * @param [in] *p_raw_hist: raw_hist_attr
 */
int ak_isp_vp_set_raw_hist_attr(
    void* isp_struct, AK_ISP_RAW_HIST_ATTR* p_raw_hist);

/**
 * @brief: get raw_hist_attr
 * @author: xiepenghe
 * @date: 2016-5-06
 * @param [in] *p_raw_hist: raw_hist_attr
 */    
int ak_isp_vp_get_raw_hist_attr(
    void* isp_struct, AK_ISP_RAW_HIST_ATTR* p_raw_hist);
